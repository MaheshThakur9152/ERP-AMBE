    ...
    const recordPayload = {
      ...
      payload: {
        ...
        party: {
          ...
          workOrderRefNo: selectedSite.workOrderRefNo || '',
          workOrderPeriod: selectedSite.workOrderPeriod || '',
        },
        bank: currentCompany
          ? {
        ...
        sgstPercent: 9,
        type: 'Material Invoice',
        terms: termsOfDelivery || 'Standard Payment Terms',
        taxGroups: calc.taxGroups,
        subTotal: calc.goodsSubTotal,
