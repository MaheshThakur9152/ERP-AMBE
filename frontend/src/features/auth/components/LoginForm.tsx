  ...
  return (
    <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl overflow-hidden font-sans border border-gray-100">
      ...
      <div className="bg-[#20B2AA] p-8 text-center text-white">
        ...
        <p className="text-white/80 mt-1 text-xs">Role-Based Enterprise Portal</p>
      </div>
      ...
      <div className="p-8">
        <form onSubmit={handleLogin} className="space-y-5">
          {error && (
            <div className="text-xs p-3 rounded-lg border text-center bg-red-50 text-red-600 border-red-100">
              {error}
            </div>
          )}
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="e.g. ambe@ambe.local"
                autoFocus
                required
              />
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#20B2AA] hover:bg-[#1ca19a] active:bg-[#188e88] text-white font-bold py-3 rounded-xl shadow-md transition-all flex items-center justify-center gap-2 text-sm mt-2 disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {loading ? (
        ...
        <div className="mt-6 text-center">
          <p className="text-[11px] text-gray-400 font-mono">
            10-Year HTTP-Only Cookie Session Enabled
          </p>
          <p className="text-[10px] text-gray-300 font-mono mt-0.5">RBAC Mode: Active</p>
        </div>
      </div>
    </div>
  );
